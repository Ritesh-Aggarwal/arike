...
"""
from app.views import (AddTreatementNoteView, AgendaView, AssignNurseView, CreateDiseaseHistoryView, CreateMemberView,
...
urlpatterns += [
    path('patient/<pk>/assign-nurse',AssignNurseView.as_view(),name='patient')
]
